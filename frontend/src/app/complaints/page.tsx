  ...
  return (
    <div>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20, flexWrap: "wrap", gap: 12 }}>
        <div>
          <h1 style={{ margin: 0, fontSize: 24, fontWeight: 800, color: "#0f172a" }}>
            {user?.role === "student" ? "My Campus Complaints" : "Complaints & Maintenance Log"}
          </h1>
          ...
          {["all", "open", "assigned", "in_progress", "resolved", "escalated"].map((s) => (
            <button
              ...
              style={{
                ...
                borderColor: filterStatus === s ? "#1e40af" : "#cbd5e1",
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
        {loading ? (
          <div style={{ textAlign: "center", padding: "40px 0", color: "#64748b" }}>Loading complaints list...</div>
        ) : filtered.length === 0 ? (
          <div style={{
          ...
          filtered.map((c) => (
            <Link key={c.id} href={`/complaints/${c.id}`} style={{ textDecoration: "none" }}>
              <div style={{
                ...
                borderLeft: `5px solid ${priorityColor[c.priority]}`,
