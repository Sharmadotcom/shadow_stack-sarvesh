...
async function testBackend() {
  ...
  try {
    ...
    console.log("[PASS] Health Check Passed:", data);
  } catch (err) {
  ...
  try {
    ...
    console.log("[PASS] Student Login Passed. Token acquired for:", studentUser.name);
  } catch (err) {
    console.error("[FAIL] Student Login Failed:", err.message);
  }
  ...
  try {
    ...
    console.log("[PASS] Admin Login Passed. Token acquired.");
  } catch (err) {
  ...
  try {
    ...
    console.log("[PASS] Complaint Creation Passed! ID:", newComplaintId, "SLA Deadline:", data.slaDeadline);
  } catch (err) {
    console.error("[FAIL] Complaint Creation Failed:", err.message);
  }
  ...
  try {
    ...
    const data = await res.json();
    console.log("[PASS] Admin Worker Assignment Passed! Assigned to:", data.assignedTo?.name);
  } catch (err) {
    console.error("[FAIL] Worker Assignment Failed:", err.message);
  }
  ...
  try {
    ...
    const data = await res.json();
    console.log("[PASS] Analytics Engine Passed! KPI Stats:", data.stats);
  } catch (err) {
    console.error("[FAIL] Analytics Failed:", err.message);
  }
